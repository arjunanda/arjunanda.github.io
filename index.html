...
<head>
    ...
    <title>My Portfolio | Muhammad Arjunanda</title>
    <!-- font icons -->
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Muhammad Arjunanda</span>
            </h1>
        ...
        <div class="container text-center">
            ...
            <div class="about">
                <div class="about-img-holder">
                    <img src="assets/imgs/man3.png" class="about-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
                <div class="about-caption">
                    <p class="section-subtitle">Who Am I ?</p>
                    <h2 class="section-title mb-3">About Me</h2>
                    <p>
                        Hello, my name is Muhammad Arjunanda, usually called Arjun. I am a software developer relying on several well-known technologies such as PHP, Tailwind CSS, Javascript, Typescript, ReactJs, Laravel, GoLang, etc. I am a person who always wants to know and still wants to learn more in the programming world 
                    </p>
